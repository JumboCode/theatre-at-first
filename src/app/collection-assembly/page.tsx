...
export default function TestPage() {
    ...
    const componentsArray = [
        <Item title="Red T-Shirt" status="available" image="image1.png" tags="blue, red"/>,
        <Item title="Yellow Hat" status="not available" image="image2.png" tags= "yellow, loc6, orange"/>,
        <Item title="Red Sword Prop" status="available" image="image1.png" tags="wood, plastic, red"/>,
        <Item title="Purple Pants" status="available" image="image2.png" tags="purple"/>,
        <Item title="Black T-Shirt" status="not available" image="image1.png" tags="loc2, loc1"/>,
        <Item title="Green Jacket" status="available" image="image2.png" tags="green, cotton"/>,
        <Item title="Plastic Chair" status="not available" image="image2.png" tags="plastic, loc5"/>,
        <Item title="Wooden Stool" status="not available" image="image2.png" tags="loc1, wood"/>,
